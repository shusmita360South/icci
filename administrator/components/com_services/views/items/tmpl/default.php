...
<?php endif;?>
		...
		<table class="table table-striped" id="editList">
			<thead>
				...
				<th class='left'> <?php echo JHtml::_('grid.sort',  'COM_SERVICES_ITEMS_TITLE', 'a.title', $listDirn, $listOrder); ?> </th>
				<!-- <th width="180" class='left'> <?php //echo JHtml::_('grid.sort',  'COM_SERVICES_ITEMS_CATID', 'a.catid', $listDirn, $listOrder); ?> </th> -->
