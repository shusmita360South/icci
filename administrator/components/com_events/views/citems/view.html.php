 ...
 */
class EventsViewCitems extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		EventsHelper::addSubmenu('citems');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_EVENTS_TITLE_CITEMS'), 'items.png');
	...
	protected function getSortFields()
	{
		...
		'a.title' => JText::_('COM_EVENTS_CITEMS_TITLE')
		);
	}
