...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_events&task=items.saveOrderAjax&tmpl=component';
...
<?php endif;?>
		...
		<table class="table table-striped" id="editList">
			<thead>
				...
				<th class='left'> <?php echo JHtml::_('grid.sort',  'COM_EVENTS_ITEMS_TITLE', 'a.title', $listDirn, $listOrder); ?> </th>
				<!-- <th width="180" class='left'> <?php //echo JHtml::_('grid.sort',  'COM_EVENTS_ITEMS_CATID', 'a.catid', $listDirn, $listOrder); ?> </th> -->
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<td><?php if (isset($item->checked_out) && $item->checked_out) : ?>
				  ...
				  <?php endif; ?>
				  <?php if ($canEdit) : ?>
				  <a href="<?php echo JRoute::_('index.php?option=com_events&task=edit.edit&id='.(int) $item->id); ?>"> <?php echo $this->escape($item->title); ?></a>
				  <?php else : ?>
