		...
		<table class="adminlist table table-striped">
			...
			?>
				<tr class="row<?php echo $i%2; ?>">
					...
					<td><?php echo JHtml::image('com_rsmembership/admin/'.($row->block ? 'disabled.png' : 'tick.png'), '', null, true); ?></td>
			...
			?>
				<tr><td colspan="<?php echo count($this->customFields) + 9; ?>" align="center" class="center"><?php echo $this->pagination->getListFooter(); ?></td></tr>
			</table>
