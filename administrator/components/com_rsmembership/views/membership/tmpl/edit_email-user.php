...
<?php 
	...
	if (!empty($this->item->id)) 
	{
		...
		$content .= '<div class="clearfix" style="margin-bottom: 10px;"></div><div class="clearfix" style="margin-bottom: 5px;"></div><div class="button2-left btn btn-small "><div class="blank"><a data-toggle="modal" role="button" title="Select the path" href="#adduseremailfiles_subscribe">'. JText::_('COM_RSMEMBERSHIP_ADD_FILES') .'</a></div></div>
			<div class="clearfix" style="margin-bottom: 10px;"></div>';
		...
		$content .= JHtml::_('bootstrap.renderModal', 'adduseremailfiles_subscribe', array(
			'title' => '&nbsp;',
			'url' => JRoute::_('index.php?option=com_rsmembership&controller=files&view=files&task=addfile&tmpl=component&membership_id='.$this->item->id.'&function=addsubscriberfiles&email_type='.$this->email_type),
			'height' => '475',
			'width' => '660'
		));
	...
	$content .= '<span class="hasTip" title="'.JText::_('COM_RSMEMBERSHIP_MEMBERSHIP_ATTACHMENTS_DESC').'"><label for="user_email_file_id">'.JText::_('COM_RSMEMBERSHIP_MEMBERSHIP_ATTACHMENTS').'</label></span><div class="clearfix" style="margin-bottom: 10px;"></div>';

	if (!empty($this->item->id)) 
	{
		$this->email_type = 'user_email_approved';
		$content .= '<div class="clearfix" style="margin-bottom: 5px;"></div><div class="button2-left btn btn-small "><div class="blank"><a data-toggle="modal" role="button" title="Select the path" href="#adduseremailfiles_approve">'. JText::_('COM_RSMEMBERSHIP_ADD_FILES') .'</a></div></div>
			<div class="clearfix" style="margin-bottom: 10px;"></div>';

			$this->item->attachments 		   = isset($this->attachments[$this->email_type]) ? $this->attachments[$this->email_type] : array();
			$this->item->attachmentsPagination = isset($this->attachmentsPagination[$this->email_type]) ? $this->attachmentsPagination[$this->email_type]   : null;

		$content .= JHtml::_('bootstrap.renderModal', 'adduseremailfiles_approve', array(
			'title' => '&nbsp;',
			'url' => JRoute::_('index.php?option=com_rsmembership&controller=files&view=files&task=addfile&tmpl=component&membership_id='.$this->item->id.'&function=addsubscriberfiles&email_type='.$this->email_type),
			'height' => '475',
			'width' => '660'
	...
	if (!empty($this->item->id)) 
	{
		...
		$content .= '<div class="clearfix" style="margin-bottom: 5px;"></div><div class="button2-left btn btn-small "><div class="blank"><a data-toggle="modal" role="button" title="Select the path" href="#adduseremailfiles_renew">'. JText::_('COM_RSMEMBERSHIP_ADD_FILES') .'</a></div></div>
			<div class="clearfix" style="margin-bottom: 10px;"></div>';

			$this->item->attachments 		   = isset($this->attachments[$this->email_type]) ? $this->attachments[$this->email_type] : array();
			$this->item->attachmentsPagination = isset($this->attachmentsPagination[$this->email_type]) ? $this->attachmentsPagination[$this->email_type]   : null;

		$content .= JHtml::_('bootstrap.renderModal', 'adduseremailfiles_renew', array(
			'title' => '&nbsp;',
			'url' => JRoute::_('index.php?option=com_rsmembership&controller=files&view=files&task=addfile&tmpl=component&membership_id='.$this->item->id.'&function=addsubscriberfiles&email_type='.$this->email_type),
			'height' => '475',
			'width' => '660'
	...
	if (!empty($this->item->id)) 
	{
		...
		$content .= '<div class="clearfix" style="margin-bottom: 5px;"></div><div class="button2-left btn btn-small "><div class="blank"><a data-toggle="modal" role="button" title="Select the path" href="#adduseremailfiles_upgrade">'. JText::_('COM_RSMEMBERSHIP_ADD_FILES') .'</a></div></div>
			<div class="clearfix" style="margin-bottom: 10px;"></div>';

			$this->item->attachments 		   = isset($this->attachments[$this->email_type]) ? $this->attachments[$this->email_type] : array();
			$this->item->attachmentsPagination = isset($this->attachmentsPagination[$this->email_type]) ? $this->attachmentsPagination[$this->email_type]   : null;

		$content .= JHtml::_('bootstrap.renderModal', 'adduseremailfiles_upgrade', array(
			'title' => '&nbsp;',
			'url' => JRoute::_('index.php?option=com_rsmembership&controller=files&view=files&task=addfile&tmpl=component&membership_id='.$this->item->id.'&function=addsubscriberfiles&email_type='.$this->email_type),
			'height' => '475',
			'width' => '660'
	...
	if (!empty($this->item->id)) 
	{
		...
		$content .= '<div class="clearfix" style="margin-bottom: 5px;"></div><div class="button2-left btn btn-small "><div class="blank"><a data-toggle="modal" role="button" title="Select the path" href="#adduseremailfiles_addextra">'. JText::_('COM_RSMEMBERSHIP_ADD_FILES') .'</a></div></div>
			<div class="clearfix" style="margin-bottom: 10px;"></div>';

			$this->item->attachments 		   = isset($this->attachments[$this->email_type]) ? $this->attachments[$this->email_type] : array();
			$this->item->attachmentsPagination = isset($this->attachmentsPagination[$this->email_type]) ? $this->attachmentsPagination[$this->email_type]   : null;

		$content .= JHtml::_('bootstrap.renderModal', 'adduseremailfiles_addextra', array(
			'title' => '&nbsp;',
			'url' => JRoute::_('index.php?option=com_rsmembership&controller=files&view=files&task=addfile&tmpl=component&membership_id='.$this->item->id.'&function=addsubscriberfiles&email_type='.$this->email_type),
			'height' => '475',
			'width' => '660'
	...
	if (!empty($this->item->id)) 
	{
		...
		$content .= '<div class="clearfix" style="margin-bottom: 5px;"></div><div class="button2-left btn btn-small "><div class="blank"><a data-toggle="modal" role="button" title="Select the path" href="#adduseremailfiles_expire">'. JText::_('COM_RSMEMBERSHIP_ADD_FILES') .'</a></div></div>
			<div class="clearfix" style="margin-bottom: 10px;"></div>';

			$this->item->attachments 		   = isset($this->attachments[$this->email_type]) ? $this->attachments[$this->email_type] : array();
			$this->item->attachmentsPagination = isset($this->attachmentsPagination[$this->email_type]) ? $this->attachmentsPagination[$this->email_type]   : null;

		$content .= JHtml::_('bootstrap.renderModal', 'adduseremailfiles_expire', array(
			'title' => '&nbsp;',
			'url' => JRoute::_('index.php?option=com_rsmembership&controller=files&view=files&task=addfile&tmpl=component&membership_id='.$this->item->id.'&function=addsubscriberfiles&email_type='.$this->email_type),
			'height' => '475',
			'width' => '660'
