...
<form action="<?php echo JRoute::_('index.php?option=com_rsmembership&task=category.term&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" autocomplete="off" class="form-validate form-horizontal">
<?php
