...
class RSMembershipControllerTerms extends JControllerAdmin
{
	...
	public function getModel($name = 'Term', $prefix = 'RSMembershipModel', $config = array('ignore_request' => true))
	{
