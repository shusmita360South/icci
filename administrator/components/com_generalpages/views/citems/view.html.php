 ...
 */
class GeneralpagesViewCitems extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		GeneralpagesHelper::addSubmenu('citems');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_GENERALPAGES_TITLE_CITEMS'), 'items.png');
	...
	protected function getSortFields()
	{
		...
		'a.title' => JText::_('COM_GENERALPAGES_CITEMS_TITLE')
		);
	}
