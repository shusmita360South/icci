 ...
 */
class GeneralpagesViewItems extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		GeneralpagesHelper::addSubmenu('items');
	...
	{
		require_once JPATH_COMPONENT.'/helpers/generalpages.php';

		$state	= $this->get('State');
		$canDo	= GeneralpagesHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_GENERALPAGES_TITLE_ITEMS'), 'items.png');
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_generalpages');
		}
        
        //Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_generalpages&view=items');
        ...
        $form = JForm::getInstance('com_generalpages.edit', 'edit');
	...
	protected function getSortFields()
	{
		...
		'a.checked_out' => JText::_('COM_GENERALPAGES_ITEMS_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_GENERALPAGES_ITEMS_CHECKED_OUT_TIME'),
		'a.created_by' => JText::_('COM_GENERALPAGES_ITEMS_CREATED_BY'),
		'a.catid' => JText::_('COM_GENERALPAGES_ITEMS_CATID'),
		'a.title' => JText::_('COM_GENERALPAGES_ITEMS_TITLE'),
		);
	}
