 ...
 */
class StaffsViewCitems extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		StaffsHelper::addSubmenu('citems');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_STAFFS_TITLE_CITEMS'), 'items.png');
	...
	protected function getSortFields()
	{
		...
		'a.title' => JText::_('COM_STAFFS_CITEMS_TITLE')
		);
	}
