...
/**
 * View class for a list of Staffs.
 */
class StaffsViewItems extends JViewLegacy
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		$canDo	= StaffsHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_STAFFS_TITLE_ITEMS'), 'items.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_staffs&view=items');
        ...
        $form = JForm::getInstance('com_staffs.edit', 'edit');
	...
	protected function getSortFields()
	{
		...
		'a.checked_out' => JText::_('COM_STAFFS_ITEMS_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_STAFFS_ITEMS_CHECKED_OUT_TIME'),
		'a.created_by' => JText::_('COM_STAFFS_ITEMS_CREATED_BY'),
		'a.catid' => JText::_('COM_STAFFS_ITEMS_CATID'),
		'a.title' => JText::_('COM_STAFFS_ITEMS_TITLE'),
		);
	}
