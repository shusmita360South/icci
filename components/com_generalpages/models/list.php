...
class GeneralpagesModelList extends JModelList {
...
#		echo '<pre>';print_r($params);echo '</pre>';
    ...
    protected function getListQuery() {
		...
		$query->from($db->quoteName('#__generalpages_items', 'ni'));
		$query->join('LEFT', $db->quoteName('#__generalpages_categories', 'nc') . ' ON (' . $db->quoteName('ni.catid') . ' = ' . $db->quoteName('nc.id') . ')');
