...
class JFormFieldGeneralpages extends JFormField
{
	protected $type = 'generalpages';
	...
	protected function getInput()
	{
		...
		$query->from('#__generalpages_items');
		$query->where('state=1');
		...
		$options		= array();
		$options[0]		= JHtml::_('select.option', '0', '- Select Generalpages -');
