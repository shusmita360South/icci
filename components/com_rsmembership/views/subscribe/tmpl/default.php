				...
				<tr>
					...
					<td>
						<?php if ($this->one_page_checkout) { ?>
							<input type="text" name="coupon" class="rsm_textbox" id="coupon" oninput="RSMembership.buildTotal.set_coupon(this.value,<?php echo $this->membership->id; ?>)" size="40" value="" maxlength="64" />
						...
						<?php } else { ?>
							<input type="text" name="coupon" class="rsm_textbox" id="coupon" size="40" value="" maxlength="64" />
						<?php } ?>
					</td>
				</tr>
			</table>
