...
class ContactformControllerForm extends ContactformController
{
	...
	public function contact_submit()
	{
		...
		if (!$captcha_response->success) {
			...
			$db->insertObject('#__contactform_submissions', $submission, 'id');
	...
	public function contact_hostsubmit()
	{
		// Check for request forgeries.
        #		JSession::checkToken() or jexit(JText::_('JINVALID_TOKEN'));
	...
	public function rsmembership_logouplod()
	{
		...
		if ($logofilename != ""){
			...
			// if everything is ok, try to upload file
				...
				if ($result = $db->execute())
					{
						$fileuploadsuccess = "Logo successfully uploaded";
					}
		...
		$return = array('error'=>$fileuploaderror, 'success'=>$fileuploadsuccess, 'file'=>$logofilename);
