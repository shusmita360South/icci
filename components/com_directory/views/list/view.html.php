...
/**
 * View class for a list of Directory.
 */
class DirectoryViewList extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
        ...
        $this->params       = $app->getParams('com_directory');
	...
	protected function _prepareDocument()
	{
		...
		if($menu)
		{
			...
			$this->params->def('page_heading', JText::_('com_directory_DEFAULT_PAGE_TITLE'));
		}
	...
	public function getCurrentSearch($array2 = array())
	{
		...
		return JRoute::_('index.php?option=com_directory&' . http_build_query($array1, '', '&amp;'));
	}
	...
	public static function getTypes() {
		...
		$query->select('*')
		    ->from($db->quoteName('#__directory_categories'))
		    ->order('ordering DESC');
		$db->setQuery($query);
