...
abstract class StaffsHelper
{
	...
	public static function getCategory($id)
	{
		...
		$query->select('*');
		$query->from('#__staffs_categories');
		$query->where('id = '.$id);
...
#		echo '<pre>'; print_r($rows); echo '</pre>';
	...
	public static function getRelatedStaffs() {
		$db  = JFactory::getDbo();
		$query = $db->getQuery(true);
		$query->select('*')
		    ->from($db->quoteName('#__staffs_items'))
