...
<div class="item-page">
    ...
    <tr>
        ...
        <td><input name="username" id="username" type="text" class="rsm_textbox input-xlarge uk-input" alt="username" size="18" /></td>
    </tr>
    <tr>
        <td width="30%" height="40"><label for="passwd"><?php echo JText::_('COM_RSMEMBERSHIP_PASSWORD') ?></label></td>
        <td><input type="password" id="passwd" name="password" class="rsm_textbox input-xlarge uk-input" size="18" alt="password" /></td>
    </tr>
